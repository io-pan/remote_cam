...
type TrackedMotionFeature = MotionFeature & { // iopan
  motionID?: number,
};
...
type PropsType = typeof View.props & {
  ...
  // iopan 
  motionDetectionMode?: number,
  motionDetectionThreshold?: number,
  motionDetectionSampleSize?: number,
  motionDetectionArea?: string,
  ...
  motionDetectionMinimumPixels?: number, // iopan
  autoFocus?: string | boolean | number,
  autoFocusPointOfInterest?: { x: number, y: number },
  faceDetectionClassifications?: number,
  onFacesDetected?: ({ faces: Array<TrackedFaceFeature> }) => void,
  onMotionDetected?: ({ motion: Array<TrackedMotionFeature> }) => void, // iopan
...
export default class Camera extends React.Component<PropsType, StateType> {
  static Constants = {
    ...
    MotionDetection: CameraManager.MotionDetection, // iopan
    CameraStatus,
  ...
  static ConversionTables = {
    ...
    // iopan
    motionDetectionMode: (CameraManager.MotionDetection || {}).Mode,
    motionDetectionMinimumPixels: (CameraManager.MotionDetection || {}).MinimumPixels,
    motionDetectionThreshold: (CameraManager.MotionDetection || {}).Threshold,
    motionDetectionSampleSize: (CameraManager.MotionDetection || {}).SampleSize,
    motionDetectionArea: (CameraManager.MotionDetection || {}).Area,
  ...
  static propTypes = {
	...
	onMotionDetected: PropTypes.func, // iopan
    ...
    motionDetectionMode: PropTypes.number,// iopan
    motionDetectionMinimumPixels: PropTypes.number,// iopan
  ...
  static defaultProps: Object = {
    ...
    motionDetectionMode: (CameraManager.MotionDetection || {}).fast,// iopan
    ...
    motionDetectionMinimumPixels: ((CameraManager.MotionDetection || {}).MinimumPixels || {}).none,// iopan
  ...
  async getPreviewSize() {
    if (Platform.OS === 'android') {
      return await CameraManager.getPreviewSize(this._cameraHandle);
    } else {
      ...
      return (
        <View style={style}>
          <RNCamera
            ...
            onMotionDetected={this._onObjectDetected(this.props.onMotionDetected) /* iopan*/}
  ...
  _convertNativeProps({ children, ...props }: PropsType) {
    ...
    if (props.onMotionDetected) {
      newProps.motionDetectorEnabled = true;
    }
...
const RNCamera = requireNativeComponent('RNCamera', Camera, {
  nativeOnly: {
    ...
    motionDetectorEnabled: true, // iopan
