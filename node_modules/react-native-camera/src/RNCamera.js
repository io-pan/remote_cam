...
type TrackedMotionFeature = MotionFeature & {
  motionID?: number,
};
...
type PropsType = typeof View.props & {
  ...
  motionDetectionMinimumPixels?: number,
  autoFocus?: string | boolean | number,
  autoFocusPointOfInterest?: { x: number, y: number },
  faceDetectionClassifications?: number,
  onFacesDetected?: ({ faces: Array<TrackedFaceFeature> }) => void,
  onMotionDetected?: ({ motion: Array<TrackedMotionFeature> }) => void,
...
export default class Camera extends React.Component<PropsType, StateType> {
  static Constants = {
    ...
    MotionDetection: CameraManager.MotionDetection,
    CameraStatus,
  ...
  static propTypes = {
    ...
    motionDetectionMode: PropTypes.number,
    motionDetectionMinimumPixels: PropTypes.number,
  ...
  static defaultProps: Object = {
    ...
    motionDetectionMode: (CameraManager.MotionDetection || {}).fast,
    ...
    motionDetectionMinimumPixels: ((CameraManager.MotionDetection || {}).MinimumPixels || {}).none,
      ...
      return (
        <View style={style}>
          <RNCamera
            ...
            onMotionDetected={this._onObjectDetected(this.props.onMotionDetected)}
