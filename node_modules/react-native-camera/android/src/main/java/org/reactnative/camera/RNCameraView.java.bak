...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate,
  ...
  private int mMotionDetectorMode = 0; // 0: running, returns only boolean; 1: preview, returns motion bitmap.
  ...
  public RNCameraView(ThemedReactContext themedReactContext) {
    ...
    addCallback(new Callback() {
      ...
      public void onFramePreview(CameraView cameraView, byte[] data, int width, int height, int rotation) {
		...
		boolean willCallMotionTask = mShouldDetectMotion && !motionDetectorTaskLock && cameraView instanceof MotionDetectorAsyncTaskDelegate;
