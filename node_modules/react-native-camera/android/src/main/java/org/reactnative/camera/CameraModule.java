...
public class CameraModule extends ReactContextBaseJavaModule {
    ...
    return Collections.unmodifiableMap(new HashMap<String, Object>() {
      {
        ...
        put("MotionDetection", Collections.unmodifiableMap(new HashMap<String, Object>() {
          {
            put("Mode", getMotionDetectionModeConstants());
          }

          private Map<String, Object> getMotionDetectionModeConstants() {
            return Collections.unmodifiableMap(new HashMap<String, Object>() {
              {
                // put("fast", MotionDetector.FAST_MODE);
                // put("accurate", MotionDetector.ACCURATE_MODE);
              }
            });
          }
        }));
  ...
  public void getSupportedRatios(final int viewTag, final Promise promise) {
    ...
    @ReactMethod
    public void getPreviewSize(final int viewTag, final Promise promise) {
        final ReactApplicationContext context = getReactApplicationContext();
        UIManagerModule uiManager = context.getNativeModule(UIManagerModule.class);
        uiManager.addUIBlock(new UIBlock() {
            @Override
            public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                ...
                try {
                    ...
                    promise.reject("E_CAMERA_BAD_VIEWTAG", "getPreviewSizeAsync: Expected a Camera component");
                }
            }
        });
    }
