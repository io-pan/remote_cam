...
// ioPAN ?
    EVENT_ON_MOTION_DETECTED("onMotionDetected"),
    EVENT_ON_BARCODES_DETECTED("onGoogleVisionBarcodesDetected"),
    EVENT_ON_FACE_DETECTION_ERROR("onFaceDetectionError"),
    EVENT_ON_MOTION_DETECTION_ERROR("onMotionDetectionError"),
  ...
  // iopan
  @ReactProp(name = "motionDetectorEnabled")
  public void setMotionDetecting(RNCameraView view, boolean motionDetectorEnabled) {
    view.setShouldDetectMotion(motionDetectorEnabled);
  }

  @ReactProp(name = "motionDetectionMode")
  public void setMotionDetectionMode(RNCameraView view, int mode) {
    view.setMotionDetectionMode(mode);
  }

  @ReactProp(name = "motionDetectionThreshold")
  public void setMotionDetectionThreshold(RNCameraView view, int threshold) {
    view.setMotionDetectionThreshold(threshold);
  }

  @ReactProp(name = "motionDetectionSampleSize")
  public void setMotionDetectionSampleSize(RNCameraView view, int size) {
    view.setMotionDetectionSampleSize(size);
  }

  @ReactProp(name = "motionDetectionArea")
  public void setMotionDetectionArea(RNCameraView view, String area) {
    view.setMotionDetectionArea(area);
  }

  @ReactProp(name = "motionDetectionMinimumPixels")
  public void setMotionDetectionMinimumPixels(RNCameraView view, int pixelsNumber) {
    view.setMotionDetectionMinimumPixels(pixelsNumber);
