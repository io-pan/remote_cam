...
public class RNCameraViewHelper {
  ...
  // iopan Motion
  public static void emitMotionDetectedEvent(
      ViewGroup view,
      WritableMap motions,
    ...
    MotionDetectedEvent event = MotionDetectedEvent.obtain(
        view.getId(),
        motions,
        dimensions,
        scaleX,
  ...
  public static void emitMotionDetectionErrorEvent(ViewGroup view, MotionDetector motionDetector) {
    MotionDetectionErrorEvent event = MotionDetectionErrorEvent.obtain(view.getId(), motionDetector);
    ReactContext reactContext = (ReactContext) view.getContext();
    reactContext.getNativeModule(UIManagerModule.class).getEventDispatcher().dispatchEvent(event);
  }
