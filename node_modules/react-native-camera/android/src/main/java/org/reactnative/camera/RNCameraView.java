...
import org.reactnative.camera.utils.ImageDimensions;// iopan
import org.reactnative.camera.utils.RNFileUtils;
import org.reactnative.facedetector.RNFaceDetector;
import org.iopan.motiondetector.MotionDetector;// iopan
...
public class RNCameraView extends CameraView 
  implements 
    ...
    MotionDetectorAsyncTaskDelegate, // iopan
  ...
  public volatile boolean motionDetectorTaskLock = false; // iopan
  ...
  private MotionDetector mMotionDetector; // iopan
  ...
  public RNCameraView(ThemedReactContext themedReactContext) {
    ...
    addCallback(new Callback() {
      ...
      public void onFramePreview(CameraView cameraView, byte[] data, int width, int height, int rotation) {
        ...
        if (
			!willCallMotionTask && // iopan
			!willCallBarCodeTask && !willCallFaceTask && !willCallGoogleBarcodeTask && !willCallTextTask) {
          return;
        }
