...
//         Rect focusAreaRect = new Rect();

//         focusAreaRect.set(touchRect.left * 2000 / this.getView().getWidth() - 1000,
//           touchRect.top * 2000 / this.getView().getHeight() - 1000,
//           touchRect.right * 2000 / this.getView().getWidth() - 1000,
//           touchRect.bottom * 2000 / this.getView().getHeight() - 1000);

//         Camera.Area focusArea = new Camera.Area(focusAreaRect, 1000);

//         mImpl.submitFocusAreaRect(focusArea);
//         return true;
//       }
//       return false;
//     }
